export const environment = {
  ...
  sidePages: {
    'servicos' :{
      ...
      subtitle: 'Encontre o suporte necessário em nossa ampla gama de serviços.'
    },
    'sobre' :{
      title: 'Sobre Nós',
      subtitle: 'Conheça nossa história e como nos tornamos especialistas em cuidados infantis.'
    },
    'loja' :{
      title: 'Loja',
